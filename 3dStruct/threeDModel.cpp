 ...
 *	Returns	: void
 */
void CThreeDModel::DrawElementsUsingVBO(Shader * myShader)
{
	glBindVertexArray(m_uiVaoID);
 ...
 *	Returns	: void
 */
void CThreeDModel::DrawBoundingBox(Shader* shader)
{
 ...
 *	Returns	: void
 */
void CThreeDModel::DrawAllBoxesForOctreeNodes(Shader* shader)
{
	if (m_pobOctree != nullptr)
	{
 ...
 *	Returns	: void
 */
void CThreeDModel::DrawOctreeLeaves(Shader* shader)
{
	if (m_pobOctree != nullptr)
	{
