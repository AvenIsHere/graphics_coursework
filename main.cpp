...
int main(int argc, char** argv) {
    ...
    auto axes_material_data = std::tuple<std::array<float, 4>, std::array<float, 4>, std::array<float, 4>, float>{
        {0.1f, 0.1f, 0.1f, 1.0f},
        {0.8f, 0.8f, 0.5f, 1.0f},
        {0.9f, 0.9f, 0.8f, 1.0f},
        50
    ...
    Application::scene->add_object(std::make_unique<ModelObject>("TestModels/airplane.obj", "BasicView",glm::vec3(0, 0, 5), axes_material_data));
    Application::scene->add_object(std::make_unique<ModelObject>("TestModels/airplane.obj", "BasicView",glm::vec3(0, 100, 5), axes_material_data));
