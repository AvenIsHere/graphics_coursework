...
CShader::CShader()
{
	...
	m_bInitShader = false;
	proj_location = glGetUniformLocation(GetProgramObjID(), "ProjectionMatrix");
	model_view_location = glGetUniformLocation(GetProgramObjID(), "ModelViewMatrix");
 ...
 */
GLuint CShader::GetProgramObjID() const
{
...
GLint CShader::getProjLocation() const {
	return this->proj_location;
}

GLint CShader::getModelViewLocation() const {
	return this->model_view_location;
}
